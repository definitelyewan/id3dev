...
#include "id3v2TagIdentity.h" // included due to circular dependency on freeing memory
...
int id3v2WritePublisher(const char *publisher, Id3v2Tag *tag);
int id3v2WriteOriginalArtist(const char *originalArtist, Id3v2Tag *tag);
...
int id3v2WriteCredits(const char *credits, Id3v2Tag *tag);
...
char *id3v2ReadPublisher(Id3v2Tag *tag);
char *id3v2ReadOriginalArtist(Id3v2Tag *tag);
char *id3v2ReadPicture(uint8_t type, Id3v2Tag *tag);
char *id3v2ReadCredits(Id3v2Tag *tag);


// writes

ByteStream *id3v2TagToByteStream(Id3v2Tag *tag);

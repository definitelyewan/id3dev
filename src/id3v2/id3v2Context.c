 ...
 */
Id3v2ContentContext *id3v2CreateContentContext(const Id3v2ContextType type, const size_t key,
                                               const size_t max, const size_t min) {
...
char *id3v2PrintContentContext(const void *toBePrinted) {
    ...
    const int memCount = sizeof(long) + sizeof(long) + sizeof(int) + sizeof(Id3v2ContextType) + 40;

    char *str = malloc(memCount);
    memset(str, 0, memCount);

    (void) snprintf(str, memCount, "Type: %d, Key: %ld, min: %ld, max: %ld\n", c->type, c->key,
                    c->min, c->max);
...
void *id3v2CopyContentContext(const void *toBeCopied) {
    ...
    const Id3v2ContentContext *copy = (Id3v2ContentContext *) toBeCopied;
...
List *id3v2CreateTextFrameContext(void) {
    ...
    List *l = listCreate(id3v2PrintContentContext, id3v2DeleteContentContext,
                         id3v2CompareContentContext, id3v2CopyContentContext);
    ...
    // text
    toAdd = (void *) id3v2CreateContentContext(encodedString_context, id3v2djb2("text"),
                                               (size_t) SIZE_MAX, 1);
    listInsertBack(l, toAdd);
...
List *id3v2CreateUserDefinedTextFrameContext(void) {
    ...
    // desc
    toAdd = (void *) id3v2CreateContentContext(encodedString_context, id3v2djb2("desc"), SIZE_MAX,
                                               1);
    listInsertBack(l, toAdd);

    // text
    toAdd = (void *) id3v2CreateContentContext(encodedString_context, id3v2djb2("text"), SIZE_MAX,
                                               1);
    listInsertBack(l, toAdd);
...
List *id3v2CreateURLFrameContext(void) {
    ...
    // url
    void *toAdd = (void *) id3v2CreateContentContext(latin1Encoding_context, id3v2djb2("url"),
                                                     SIZE_MAX, 1);
    listInsertBack(l, toAdd);
...
List *id3v2CreateUserDefinedURLFrameContext(void) {
    ...
    // url
    toAdd = (void *) id3v2CreateContentContext(latin1Encoding_context, id3v2djb2("url"), SIZE_MAX,
                                               1);
    listInsertBack(l, toAdd);
...
List *id3v2CreateAttachedPictureFrameContext(unsigned int version) {
    ...
    case ID3V2_TAG_VERSION_4:
        // format is latin1
        toAdd = (void *) id3v2CreateContentContext(latin1Encoding_context, id3v2djb2("format"),
                                                   SIZE_MAX, 1);
        break;

    default:
        // something it wrong
        toAdd = (void *) id3v2CreateContentContext(unknown_context, id3v2djb2("format"), SIZE_MAX,
                                                   1);
        break;
    }
    ...
    // data
    toAdd = (void *) id3v2CreateContentContext(binary_context, id3v2djb2("data"), SIZE_MAX, 1);
    listInsertBack(l, toAdd);
...
List *id3v2CreateAudioSeekPointIndexFrameContext(void) {
    ...
    // data
    void *toAdd = (void *)
        id3v2CreateContentContext(binary_context, id3v2djb2("data"), SIZE_MAX, 1);
    listInsertBack(l, toAdd);
...
List *id3v2CreateAudioEncryptionFrameContext(void) {
    ...
    // identifier
    void *toAdd = (void *) id3v2CreateContentContext(latin1Encoding_context,
                                                     id3v2djb2("identifier"), SIZE_MAX, 1);
    listInsertBack(l, toAdd);
...
List *id3v2CreateCommercialFrameContext(void) {
    ...
    // price
    toAdd = (void *) id3v2CreateContentContext(latin1Encoding_context, id3v2djb2("price"), SIZE_MAX,
                                               1);
    listInsertBack(l, toAdd);
    ...
    // name
    toAdd = (void *) id3v2CreateContentContext(encodedString_context, id3v2djb2("name"), SIZE_MAX,
                                               1);
    listInsertBack(l, toAdd);
...
List *id3v2CreateEncryptedMetaFrameContext(void) {
    ...
    // content
    toAdd = (void *) id3v2CreateContentContext(latin1Encoding_context, id3v2djb2("content"),
                                               SIZE_MAX, 1);
    listInsertBack(l, toAdd);
...
List *id3v2CreateEqualizationFrameContext(unsigned int version) {
    ...
    case ID3V2_TAG_VERSION_3:
        ...
        toAdd = (void *) id3v2CreateContentContext(adjustment_context, id3v2djb2("volume"),
                                                   SIZE_MAX, 1);
        listInsertBack(l, toAdd);

        // iter through the last 3 limit is int max but a frames data will 100% run out before this
        toAdd = (void *) id3v2CreateContentContext(iter_context, id3v2djb2("iter"), SIZE_MAX, 1);
        listInsertBack(l, toAdd);
        break;
    ...
    case ID3V2_TAG_VERSION_4:
        ...
        // identifier
        toAdd = (void *) id3v2CreateContentContext(latin1Encoding_context, id3v2djb2("identifier"),
                                                   SIZE_MAX, 1);
        listInsertBack(l, toAdd);
        ...
        toAdd = (void *) id3v2CreateContentContext(iter_context, id3v2djb2("iter"), SIZE_MAX, 2);
        listInsertBack(l, toAdd);
        break;
...
List *id3v2CreateLinkedInformationFrameContext(void) {
    ...
    // data
    toAdd = (void *) id3v2CreateContentContext(noEncoding_context, id3v2djb2("data"), SIZE_MAX, 1);
    listInsertBack(l, toAdd);
...
List *id3v2CreateOwnershipFrameContext(void) {
    ...
    // data
    void *toAdd = (void *) id3v2CreateContentContext(numeric_context, id3v2djb2("encoding"),
                                                     SIZE_MAX, 1);
    listInsertBack(l, toAdd);
 ...
 * @return List*
 */
List *id3v2CreateRelativeVolumeAdjustmentFrameContext() {
...
List *id3v2CreateSynchronisedLyricFrameContext(void) {
    ...
    // iter
    toAdd = (void *) id3v2CreateContentContext(iter_context, id3v2djb2("iter"), SIZE_MAX, 5);
    listInsertBack(l, toAdd);
...
List *id3v2CreateGenericFrameContext(void) {
    ...
    // encoding
    void *toAdd = (void *) id3v2CreateContentContext(binary_context, id3v2djb2("?"), SIZE_MAX, 1);
    listInsertBack(l, toAdd);
...
HashTable *id3v2CreateDefaultIdentifierContextPairings(unsigned int version) {
    ...
    HashTable *table = hashTableCreate(minFrameContexts, id3v2DeleteContentContextList,
                                       id3v2PrintContentContextList, id3v2CopyContentContextList);
    List *l = NULL;
    ...
    case ID3V2_TAG_VERSION_2:
        ...
        listFree(l);
        hashTableInsert(table, "RVA",
                        (l = id3v2CreateRelativeVolumeAdjustmentFrameContext()));
        listFree(l);

 ...
 * @details This function will read the last 128 bytes of the file and parse them into an Id3v1Tag
 * structure. On success this function returns a pointer to the Id3v1Tag structure, otherwise it
 * returns NULL.
 * @param filePath 
 * @return Id3v1Tag* 
 */
 ...
 * @details On success this function returns a pointer to the new heap allocated Id3v1Tag
...
Id3v1Tag *id3v1CopyTag(Id3v1Tag *toCopy) {
    ...
    return id3v1CreateTag(toCopy->title, toCopy->artist, toCopy->albumTitle, toCopy->year,
                          toCopy->track,
 ...
 * @details This function is not in any header and is private to this library. It returns 1 on
 ...
 * @details Writes a title to the tag structure. This function will write up to ID3V1_FIELD_SIZE
 * bytes to the title field of the tag. On success this function returns 1, otherwise it returns 0.
 * @param title
 * @param tag
 * @return int
 */
 ...
 * @details Writes an artist to the tag structure. This function will write up to ID3V1_FIELD_SIZE
 * bytes to the artist field of the tag. On success this function returns 1, otherwise it returns 0.
 * @param artist
 * @param tag
 * @return int
 */
 ...
 * @details Writes an album to the tag structure. This function will write up to ID3V1_FIELD_SIZE
 * bytes to the album field of the tag. On success this function returns 1, otherwise it returns 0.
 * @param album
 * @param tag
 * @return int
 */
 ...
 * @details Writes a year to the tag structure. This function will write an integer to the year
 ...
 * @details Writes a comment to the tag structure. This function will write up to ID3V1_FIELD_SIZE
 * bytes to the comment filed of the tag. On success this function returns 1, otherwise it returns
 * 0.
 * @param comment
 * @param tag
 * @return int
 ...
 * @details Writes a genre to the tag structure. This function will write an integer
 * (from 0 to 255) to the genre field of the tag. On success this function returns 1, otherwise it
 * returns 0.
 * @param genre
 * @param tag
 * @return int
 ...
 * @details Writes a track number to the tag structure. This function will write an integer
 * (from 0 to 255) to the track field of the tag. On success this function returns 1, otherwise it
 * returns 0.
 * @param track
 * @param tag
 * @return int
...
char *id3v1ToJSON(const Id3v1Tag *tag) {
    ...
    // 98 is for formating
    memCount = (int) (98 + ID3V1_MAX_SIZE + (sizeof(int) * 3) + strlen(
                          id3v1GenreFromTable(tag->genre)));
    jsonStr = calloc(sizeof(char), memCount);

    (void) snprintf(jsonStr,
                    memCount,
